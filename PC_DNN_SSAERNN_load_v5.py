...
# Data load
filepath_data = 'D://CJH/Research/En2/Dataset_Atlas_ver1.mat' # Signal data path
...
RNN_models = []
num_models = len(d1_drop_rate)*len(d1_num_layer)*len(d1_num_hidden)
# =============================================================================
# Preprocessing 방법 선택
model_num = 37
# =============================================================================
...
new_saver.restore(sess, os.path.join(MODEL_PATH, 'trained_Atlas_v3.ckpt'))
