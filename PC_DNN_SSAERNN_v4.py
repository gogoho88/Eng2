...
# 새로운 LG, Atlas dataset에 맞게 data load부분 수정
# Denoise autoencoder 부분 input noise에 abs 씌워줌

## v3->v4
# Simulation 컴에서 돌리면서 자잘한 오류 수정
# In[1]:
...
# Data load
filepath_data = 'C://Users/REMT/Desktop/CJH/Research/En2/Dataset_LG.mat' # Signal data path
