...
# Data load
filepath_data = 'C://Users/REMT/Desktop/HW_final_project_Progress/signal_LG_ncor.mat' # Signal data path
...
droprate2 = np.array([0.2,0.5])
droprate3 = np.array([0.2,0.6])
d1_noiselevel = np.array([0.2,0.1,0.05,0.01,0])
